// $ANTLR 3.5.2 org/semanticweb/clipper/cqparser/CQ.g 2023-08-28 14:33:09
...
public class CQParser extends Parser {
	...
	public final CQParser.ucq_return ucq() throws RecognitionException {
		CQParser.ucq_return retval = new CQParser.ucq_return();
	...
	public final CQParser.cq_return cq() throws RecognitionException {
		CQParser.cq_return retval = new CQParser.cq_return();
		retval.start = input.LT(1);
	...
	public final CQParser.head_return head() throws RecognitionException {
		CQParser.head_return retval = new CQParser.head_return();
		retval.start = input.LT(1);
	...
	public final CQParser.body_return body() throws RecognitionException {
		CQParser.body_return retval = new CQParser.body_return();
		retval.start = input.LT(1);
	...
	public final CQParser.atom_return atom() throws RecognitionException {
		CQParser.atom_return retval = new CQParser.atom_return();
		retval.start = input.LT(1);
	...
	public final CQParser.predicate_return predicate() throws RecognitionException {
		CQParser.predicate_return retval = new CQParser.predicate_return();
		retval.start = input.LT(1);
	...
	public final CQParser.term_return term() throws RecognitionException {
		CQParser.term_return retval = new CQParser.term_return();
		retval.start = input.LT(1);
	...
	public final CQParser.variable_return variable() throws RecognitionException {
		CQParser.variable_return retval = new CQParser.variable_return();
		retval.start = input.LT(1);
	...
	public final CQParser.constant_return constant() throws RecognitionException {
		CQParser.constant_return retval = new CQParser.constant_return();
		retval.start = input.LT(1);
