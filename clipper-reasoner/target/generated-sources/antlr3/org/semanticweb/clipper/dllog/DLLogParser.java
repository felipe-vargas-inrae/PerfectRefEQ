// $ANTLR 3.5.2 org/semanticweb/clipper/dllog/DLLog.g 2023-08-28 14:33:09
...
public class DLLogParser extends Parser {
	...
	public final DLLogParser.dl_log_rules_return dl_log_rules() throws RecognitionException {
		DLLogParser.dl_log_rules_return retval = new DLLogParser.dl_log_rules_return();
	...
	public final DLLogParser.dl_log_rule_return dl_log_rule() throws RecognitionException {
		DLLogParser.dl_log_rule_return retval = new DLLogParser.dl_log_rule_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.head_return head() throws RecognitionException {
		DLLogParser.head_return retval = new DLLogParser.head_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.body_return body() throws RecognitionException {
		DLLogParser.body_return retval = new DLLogParser.body_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.atom_return atom() throws RecognitionException {
		DLLogParser.atom_return retval = new DLLogParser.atom_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.predicate_return predicate() throws RecognitionException {
		DLLogParser.predicate_return retval = new DLLogParser.predicate_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.term_return term() throws RecognitionException {
		DLLogParser.term_return retval = new DLLogParser.term_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.variable_return variable() throws RecognitionException {
		DLLogParser.variable_return retval = new DLLogParser.variable_return();
		retval.start = input.LT(1);
	...
	public final DLLogParser.constant_return constant() throws RecognitionException {
		DLLogParser.constant_return retval = new DLLogParser.constant_return();
		retval.start = input.LT(1);
