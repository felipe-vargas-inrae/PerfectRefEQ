// $ANTLR 3.5.2 org/semanticweb/clipper/hornshiq/sparql/Sparql.g 2023-08-28 14:33:09
...
public class SparqlParser extends Parser {
		...
		try {
			...
			state._fsp--;
			      ...
			      if(currentArity==1) {
			        ...
			        Term t = (o1!=null?((SparqlParser.object_return)o1).term:null);
				...
				case 1 :
					...
					state._fsp--;
					      ...
					      if(currentArity==1) {
					        ...
					        Term t = (o2!=null?((SparqlParser.object_return)o2).term:null);
					        currentBodyAtom = new Atom(currentPredicate, currentSubject, t);
					        body.add(currentBodyAtom);          
					      }
	...
	public final SparqlParser.object_return object() throws RecognitionException {
		SparqlParser.object_return retval = new SparqlParser.object_return();
